...
const _TaskTypes = {
	...
	'conditional': require('./tasks/logic/Ultravisor-Task-If.cjs'),
	...
	'commandeach': require('./tasks/logic/Ultravisor-Task-Each.cjs'),
...
class UltravisorTaskRunner extends libPictService
{
	...
	executeTask(pTaskDefinition, pContext, fCallback)
	{
		...
		// Ensure GlobalState is accessible
...
module.exports = UltravisorTaskRunner;
