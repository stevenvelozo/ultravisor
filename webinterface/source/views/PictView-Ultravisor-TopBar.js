...
<div class="ultravisor-topbar">
	...
	<div class="ultravisor-topbar-nav">
		...
		<a onclick="{~P~}.PictApplication.navigateTo('/Timeline')">Timeline</a>
		<a onclick="{~P~}.PictApplication.navigateTo('/Throughput')">Throughput</a>
		<a onclick="{~P~}.PictApplication.navigateTo('/Capabilities')">Capabilities</a>
		<a onclick="{~P~}.PictApplication.navigateTo('/Constellation')">Constellation</a>
